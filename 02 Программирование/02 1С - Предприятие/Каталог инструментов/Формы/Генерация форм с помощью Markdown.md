...
[GitHub](https://github.com/crimsongoldteam/md_design)

Проект позволяет описывать формы 1С в формате Markdown, после чего специальный ИИ переводит Markdown код на в код 1С
